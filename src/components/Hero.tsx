...
const Hero = () => {
  return (
    <div
      className="relative flex h-96 bg-cover bg-center bg-no-repeat justify-center py-44 md:py-60 font-[family-name:var(--font-poppins)]"
    ...
    >
      ...
      <div className="relative flex flex-col justify-center items-center mx-4 md:mx-0">
        ...
        <p className="mt-4 md:mt-6 text-primary text-base md:text-xl text-center">
          suppliers of materials used in handling <span className="text-secondary">warehouse</span> products
        </p>
        <button className="text-center mt-6 md:mt-6 px-4 md:px-8 py-2 md:py-3 rounded bg-secondary text-sm md:text-base">
          products
        </button>
      </div>
    </div>
