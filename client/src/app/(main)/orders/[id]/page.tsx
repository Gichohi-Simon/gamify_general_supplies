    ...
    <div className="min-h-screen px-4 md:px-12 py-8 font-[family-name:var(--font-poppins)] bg-gray-50">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <button
            onClick={() => router.back()}
            className="flex text-xs md:text-sm items-center gap-2 text-gray-700 hover:text-primary transition"
          >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-5 shadow-lg border-l-4 border-primary">
            <div className="mb-3">
              ...
              <div className="font-bold text-xs md:text-sm text-gray-800">
                {order.invoiceNumber}
              </div>
            </div>
          ...
          <div className="md:col-span-2 space-y-3">
            {order.orderItems.map((orderItem: OrderItemType) => (
              <div
                key={orderItem.id}
                className="bg-white rounded-xl p-4 flex items-center gap-4 shadow-md border-l-4 border-primary hover:shadow-lg transition"
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-sm md:text-base text-gray-800 tracking-wider">
