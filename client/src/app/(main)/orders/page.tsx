    ...
    <Protected>
      <div className="font-[family-name:var(--font-poppins)] mx-8 md:mx-20 my-5 md:my-10 min-h-screen">
        <div className="flex justify-between items-center">
          <div>
            <p className="font-bold text-base md:text-xl capitalize">order details</p>
        ...
        {data?.orders ? (
          <div>
            {orders.map((order: OrderType) => (
              <div key={order.id} className="flex border border-1 rounded-lg mt-4 md:mt-7">
                <div className="w-1/3 md:w-1/4 bg-gray-100 px-3 py-3 md:py-5 md:px-5">
                  ...
                  <div className="mt-4">
                    <p className="text-xs md:text-sm capitalize text-wider">Date</p>
                  ...
                  <div className="mt-4">
                    <p className="text-xs md:text-sm capitalize text-wider">delivery</p>
                    <p className="text-[10px]  md:text-xs text-wider font-bold">
                      ...
                      <div className="flex items-center gap-1 md:gap-4 w-full py-1 md:py-3">
                        ...
                        <div className="w-full">
                          ...
                          <div className="flex items-center gap-1 md:gap-2 mt-0 md:mt-2">
                            ...
                            <p className="text-[10px]  md:text-sm">{orderItem.quantity}</p>
                          </div>
                        </div>
                      </div>
                      <hr />
