...
export default function SingleProduct() {
  ...
  return (
    <div className="mx-5 md:mx-12 font-[family-name:var(--font-poppins)]">
      <div className="md:flex gap-6 md:gap-12 pt-6 pb-6 md:pt-16 md:pb-10">
        ...
        <div className="mt-10 md:mt-5 w-full md:w-1/2">
          ...
          <span className="text-[10px] md:text-xs bg-primary px-2 py-1 rounded-sm">
            {product.category}
          </span>
