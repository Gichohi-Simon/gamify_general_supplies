  ...
  return (
    <div className="font-[family-name:var(--font-poppins)] mx-8 md:mx-20 lg:mx-72 my-5 md:my-10 lg:my-14">
      <div className="flex justify-between">
        <span className="capitalize font-bold text-base md:text-3xl mb-5 md:mb-10 flex gap-2">
          <ShoppingCartIcon className="size-4 md:size-10" />
          <h4>your cart</h4>
        </span>

        <span className="bg-primary py-2 px-2 rounded text-xs md:text-sm cursor-pointer h-8 md:h-10">
          ...
          >
            ...
            <div className="flex justify-between flex-1 mt-6 md:mt-10 px-2 md:px-10 items-center">
              <div className="flex gap-2 md:gap-4 items-center">
                ...
                <span className="px-2 md:px-3 py-1 md:py-2 rounded bg-gray-200 cursor-pointer">
                  -
                </span>
              ...
              <span className="text-xs md:text-base px-2 py-1 rounded font-bold capitalize">
      ...
      <div className="elevation-2 shadow-lg px-4 py-10 mt-10">
        <h4 className="text-sm md:text-lg font-bold capitalize mb-10">
          summary
        </h4>
        ...
        <button className="w-full bg-secondary py-1 text-sm rounded mt-10 md:text-base">
